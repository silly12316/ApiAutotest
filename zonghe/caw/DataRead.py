...
def get_project_path():
    ...
    :return:
    '''
    cp = os.path.realpath(__file__) #D:\ApAutoTest\zonghe\caw\DataRead.py
    print(cp)
    cd = os.path.dirname(cp) #D:\ApAutoTest\zonghe\caw
    # print(cd)
    return os.path.dirname(cd) +"\\" #D:\ApAutoTest\zonghe
