"""
1. 增加异常处理
2. 新建一个session,使用 session发送请求，自动管理cookie
"""
import requests
...
class BaseRequests:
    ...
    def post(self, url, data=None, json=None, **kwargs):
        try:
            ...
            print(f"发送post请求，url:{url},请求参数data：{data},data:{data},其他：{kwargs}成功")
            return r
        except Exception as e:
            print(f"发送post请求，url:{url},请求参数data：{data},data:{data},其他：{kwargs}异常，异常信息:{e}")
