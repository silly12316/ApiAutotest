...
2. 测试的功能依赖第三方的接口，但是第三方的接口尚未开放完成
通过mock来模拟接口的返回值。
"""
import mock
import requests
...
class JinRong:
    def withdraw(self,data):
        r = requests.post("http://192.168.150.222:8081/futureloan/mvc/api/member/withdraw",data=data)
        return r.json()

def test_002():
    d = {"mobilephone":18060071811,"amount":1000}
    # 类名.方法名
